...
<body class="p-8">
    ...
    <div class="container mx-auto">
        <h2 class="text-2xl w-full font-bold text-center mt-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-1.5">Get in Touch</h2>
            ...
            <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="py-4 px-4">{{$data->user->name}} <br>{{$data->user->email}}</td>
