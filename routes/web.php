...
Route::get('admin/contact-list', [ContactController::class, 'contactMe'])->name('contact.list');
...
Route::get('admin/booking-list', [BookingController::class, 'bookingList'])->name('bookingList');
...
Route::middleware(['admin'])->group(function () {
    ...
    // Admin services
    Route::get('admin/service/add', [ServiceController::class, 'add_service'])->name('add.service');
    Route::post('/service/store', [ServiceController::class, 'service_store'])->name('service.store');
    Route::get('admin/service-list', [ServiceController::class, 'service_list'])->name('service.list');
    Route::get('/service/edit/{id}', [ServiceController::class, 'edit'])->name('service.edit');
    Route::post('/service/update/{id}', [ServiceController::class, 'service_update'])->name('service.update');
    Route::get('/service/delete/{id}', [ServiceController::class, 'delete'])->name('service.delete');
    //admin blog
    Route::get('admin/add-blog', [BlogController::class, 'add_blog'])->name('add-blog');
    Route::post('admin/blog-store', [BlogController::class, 'blog_store'])->name('blog-store');
    Route::get('admin/all-blog', [BlogController::class, 'all_blog'])->name('all-blog');
    Route::get('admin/edit-blog/{id}', [BlogController::class, 'edit_blog'])->name('edit-blog');
    Route::post('admin/blog-update/{id}', [BlogController::class, 'blog_update'])->name('blog-update');
    Route::get('admin/blog-delete/{id}', [BlogController::class, 'delete'])->name('blog-delete');
    //admin team
    Route::get('admin/add-team', [TeamController::class, 'add_team'])->name('add.team');
    Route::post('admin/team-added', [TeamController::class, 'team_added'])->name('teamAdded');
    Route::get('admin/team-list', [TeamController::class, 'team_list'])->name('team.list');
    Route::get('admin/team-delete', [TeamController::class, 'team_delete'])->name('delete');
    //why chooose us
    Route::get('admin/add-choose', [WhyUsController::class, 'add_choose'])->name('add-choose');
    Route::post('admin/choose-store', [WhyUsController::class, 'choose_store'])->name('choose_store');
    Route::get('admin/all-choose', [WhyUsController::class, 'all_choose'])->name('all-choose');
