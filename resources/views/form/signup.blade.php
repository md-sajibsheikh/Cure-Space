...
<body class="bg-gradient-to-r from-purple-400 to-blue-500">
        ...
        <div class="w-full max-w-md p-6 space-y-6 bg-white rounded-lg shadow-lg sm:p-8 lg:p-10">
            ...
            <form action="{{ route('signupData') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4 text-center">
                    ...
                    <div class="mt-2">
                        <img id="preview-image" class="w-20 h-20 rounded-full mx-auto border border-gray-300"
                            src="https://via.placeholder.com/150" alt="Preview">
                    </div>
                    <input type="file" name="img" id="image"
                        class="w-full px-4 py-2 mt-4 text-gray-700 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500"
                ...
                <div class="mt-4">
                    ...
                    <input type="text" value="{{old('name')}}" name="name" id="name" required
                        class="w-full px-4 py-2 mt-1 text-gray-700 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">
                    @error('name')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-4 relative">
                    ...
                    <input type="password" name="password" id="password" required
                        class="w-full px-4 py-2 mt-1 text-gray-700 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">
                    <button type="button" onclick="togglePasswordVisibility('password')" class="absolute right-3 top-9 text-gray-600">
                ...
                <div class="mt-4 relative">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" required
                        class="w-full px-4 py-2 mt-1 text-gray-700 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500">
                    <button type="button" onclick="togglePasswordVisibility('password_confirmation')" class="absolute right-3 top-9 text-gray-600">
                ...
                <button type="submit"
                    class="w-full px-4 py-2 mt-6 font-semibold text-white bg-green-500 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Signup
                </button>
            </form>
    ...
    <script>
        ...
        function togglePasswordVisibility(inputId) {
            ...
            const eyeIcon = inputId === 'password' ? document.getElementById('eye-icon-password') : document.getElementById('eye-icon-confirm');
